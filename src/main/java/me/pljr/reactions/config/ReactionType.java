...
public enum ReactionType {
    ...
    DROP_ITEM(5, new ItemBuilder(XMaterial.DIAMOND).withName("&eItems dropped:").withLore("&8► &7{amount}", "", "&aServer top:", "&f{topName} &7- &f{topAmount}").create(), 100.0, "&eDrop &fan item and win!"),
